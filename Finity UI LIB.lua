...
function finity.new(isdark, gprojectName, thinProject)
	...
	self2.ChangeToggleKey = function(NewKey)
		...
		if not projectName then
			self2.tip.Text = "Synthx Hub - Press T to hide Synthx Hub"
		end
	...
	self2.tip = self:Create("TextLabel", {
		...
		Text = "Synthx Hub - Press T To Hide Synthx Hub",
	...
	if projectName then
		...
		self2.tip.Text = "Synthx Hub - Press - Press T To Hide Synthx Hub"
	end
